...
<head>
  ...
  <title>Siam_Tracer: Trace any IP address for FREE</title>
</head>
...
<body>
            ...
            <table class="item table table-bordered h-100 p-4 first">
              <tbody>
               <p class="detail" >Check More detail of your victim</p>
                ...
                <tr>
                  <td>Currency Name:</td>
                  <td><?php echo $jlson['currency'] ['name']; ?></td>
                </tr>
                <tr>
  ...
  <div class="contx col-md-4">
    <div class="yeah">
     <a href="https://instagram.com/skillsiam/" target="_blank" ><i class="fab fa-instagram"></i></a>
     <a href="https://facebook.com/skillsiam1245/" target="_blank" ><i class="fab fa-facebook"></i></a>
     <a href="https://github.com/siamrahman000/" target="_blank" ><i class="fab fa-github"></i></a>
     <a href="https://youtube.com/@skillsiam1245/" target="_blank" ><i class="fab fa-youtube"></i></a>
   </div>
  </div>
